...
public class Event
{
    ...
    public Event(String eventID, String eventRegistrarID, String eventRegistrarName, EventType eventType, String eventDate, String eventName, String eventVenue, String eventStartTime, String eventEndTime, String eventCost, ArrayList<String> years, ArrayList<String> branches) {
    ...
    public String toString() {
        return "Event{" +
                "eventID='" + eventID + '\'' +
                ", eventRegistrarID='" + eventRegistrarID + '\'' +
                ", eventRegistrarName='" + eventRegistrarName + '\'' +
                ", eventType=" + eventType +
                ", eventDate='" + eventDate + '\'' +
                ", eventName='" + eventName + '\'' +
